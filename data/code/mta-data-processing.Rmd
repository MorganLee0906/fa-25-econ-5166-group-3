...
df
write.csv(df, paste0(base_path, "/data/processed/mta_hourly.csv"), row.names = FALSE)
...
df
write.csv(df, file.path(base_path, "/data/processed/mta_daily.csv"), row.names = FALSE)
```