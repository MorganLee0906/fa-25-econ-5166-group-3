...
- **Research Motivation and Context (why are we interested in the findings?)：** We want to check whether the MTA ridership increase after the policy implemented in early 2025.
- **Main Findings and Takeaways：** The daily ridership increased significantly in 2025 compared to 2024.
- **Future Direction：** We may check whether the trip in/out of Manhattan has different patterns. Also, we can analyze more data to check whether the increasing is a seasonal trend or not.
